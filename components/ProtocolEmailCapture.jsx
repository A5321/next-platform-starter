...
export default function ProtocolEmailCapture({ protocolScope, protocolTier, protocolTitle, testName }) {
  ...
  return (
    ...
    >
      <p style={{ margin: "0 0 4px 0", fontSize: 15, fontWeight: 600, color: "#1a1a1a" }}>
        Get your protocol by email
      </p>
      <p style={{ margin: "0 0 16px 0", fontSize: 14, color: "#6b7280", lineHeight: 1.5 }}>
      ...
      {errorMsg && (
        <p style={{ margin: "10px 0 0 0", fontSize: 13, color: "#dc2626" }}>{errorMsg}</p>
      )}
